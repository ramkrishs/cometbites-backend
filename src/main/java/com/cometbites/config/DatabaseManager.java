...
public class DatabaseManager {
	...
	public MongoDbFactory mongoDbFactory() throws Exception {
		...
		// Set credentials
		MongoCredential credential = MongoCredential.createCredential("root", "cometbites",
				("github123").toCharArray());
		...
		// Mongo DB Factory
		SimpleMongoDbFactory simpleMongoDbFactory = new SimpleMongoDbFactory(mongoClient, "cometbites");
